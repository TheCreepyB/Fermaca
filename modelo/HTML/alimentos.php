...
<nav class="navbar navbar-expand-md navbar-light bg-white ">
    ...
    <div class="container">
        ...
        <div id="navBar" class="collapse navbar-collapse">
            <ul class=" navbar-nav  ml-auto">
                <li class="nav-item"><a class="nav-link" href="../../../FermacaRework/index.php">Inicio </a></li>
                <li class="nav-item"><a class="nav-link" href="../../../FermacaRework/modelo/HTML/catalogo.php">Catalogo</a></li>
                <li class="nav-item"><a class="nav-link" href="#MarRecom">Contacto</a></li>
                <button type="button" onclick="enviarLogin()">Login</button>
            </ul>
        </div>
    </div>
...
<body class="bg-light">
    <?php	
        include("../../controlador/php/previewPro.php");
    ?>
    <div class="container">
        <div class="row">
